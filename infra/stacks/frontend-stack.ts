...
export class FrontendStack extends cdk.Stack {
    ...
    const { domainName, region } = props.env; 

    const fullDomainName = `${props.env.subDomainPrefix}.${props.env.domainName}`;
    ...
    this.cloudFrontDistribution = new cloudfront.Distribution(this, `${applicationName}-cloudfront-distribution`, {
        ...
        domainNames: [domainName, `${fullDomainName}`, `www.${fullDomainName}`],
