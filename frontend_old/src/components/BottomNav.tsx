...
import { appRoutes } from '../context/Providers/AppState/useRouteHistory';
    ...
    <Box position="fixed" bottom={0} width="100%">
      ...
      >
        ...
        <Link to={appRoutes.Invitation}>
          <BottomNavigationAction showLabel={true} value={appRoutes.Invitation} label="Invitation" icon={<ConnectWithoutContactIcon />} />
        </Link>
        <Link to={appRoutes.Profile} onClick={() => user ? () => {} : loginWithPopup()}>
          <BottomNavigationAction showLabel={true} value={appRoutes.Profile} label="Profile" icon={<ProfileIcon />} />
        </Link>
      </BottomNavigation>
    </Box>
  );
