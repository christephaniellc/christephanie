...
// using Wedding.Lambdas.Admin.NotifyGuests.Handlers;
//
...
//         serviceCollection.AddScoped<AdminNotifyGuestsHandler>();
//
...
//
//             var query = new AdminNotifyGuestsCommand(authContext);
//             
