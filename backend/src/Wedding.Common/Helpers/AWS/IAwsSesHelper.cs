...
namespace Wedding.Common.Helpers.AWS
{
    public interface IAwsSesHelper
    {
        ...
        Task<SendEmailResponse?> SendRsvpNotificationEmail(string name, string email, bool guestInterested, string invitationCode, CancellationToken cancellationToken);
    }
}
